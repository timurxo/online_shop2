...
public class Users {
    ...
    public Users(Session ses) {
        registeredUsers.add(new User(userId, password, phone_number, address, credit_card_number, "customer"));
        registeredUsers.add(new User(username, password, phone_number, address, credit_card_number, "supplier"));
        session = ses;
    }
